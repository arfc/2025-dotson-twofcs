...
\begin{questions}
        ...
        \begin{solution}
                ...
                \begin{quote}
                        Considering sub-optimal solutions is useful for
                        addressing structural uncertainty, which relates to the
                        existence of unmodeled or unmodelable objectives [2, 4].
                        Due to structural uncertainty, decision-makers may find
                        appealing alternative solutions in a model’s sub-optimal
                        space.
                \end{quote}
        \end{solution}
        ...
        \begin{solution}
                ...
                \begin{quote}
                        We assumed that the nuclear fuel cycles represented in
                        the SET Tool are mutually exclusive. That is,
                        decision-makers will choose a single fuel cycle option,
                        rather than a mixture of fuel cycles.
                \end{quote}
        \end{solution}
        ...
        \begin{solution}
                ...
                \begin{quote}
                        All of the ``most promising'' fuel cycles (EGs
                        23,24,29,30) were found to be Pareto Optimal,
                        demonstrating some agreement between Osier and the E\&S.
                \end{quote}
        \end{solution}
...
the response variable? Are the differences large enough to matter?
        \begin{solution}
                ...
                enough to matter. In section 3.2 we identified some disagreement
                between a Pareto optimal approach and the conclusions of the
                E\&S. 
        \end{solution}
...
may help to clarify this point in how these fuel cycles are ``sub-optimal.''
        \begin{solution}
                I understand the confusion. A ``sub-optimal'' solution is not
                Pareto optimal, by definition. Further, no sub-optimal solutions
                out perform any other solutions on any metric. Such a solution
                would still be Pareto optimal (but an ``anchor point'').
...
meaning.)
        \begin{solution}
                ...
                \begin{quote}
                        we identified this as a point of disagreement because
                        its status as a “high-compromise” solution should
                        elevate its consideration since this point represents
                        the greatest balance among competing objectives.
                \end{quote}
        \end{solution}
